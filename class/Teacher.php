...
class Teacher {
    ...
    /**
     * 
     * @param string $type "other_normal" : HOD and ExCo; "normal" : others
    ...
    public static function getTeacherInfo($type)
    {
        ...
        if(strcmp($type, "other_normal") === 0)
        {
            $in_array = Teacher::getTeacherName('executive');
        }
        else if(strcmp($type, "normal") === 0)
        {
            $in_array = Teacher::getTeacherName('non-executive');
        }
        else
        {
            $in_array = Array();
